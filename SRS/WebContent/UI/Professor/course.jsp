	    ...
	    <tbody>
	   		<s:iterator value="soutList">
		        <tr>
	                ...
	                <td><a href="details.jsp?sectionNo=<s:property value='sectionNo'/>&ssn=<s:property value='ssn'/>">编辑</a></td>
		       		<td><a href="delCourse?sectionNo=<s:property value='sectionNo'/>">删除</a></td>
		         </tr>
	         </s:iterator>
         </tbody>
    </table>
